...
$sonucm -> execute([$value['belgeId']]);
		...
		while($bilgilerimceka=$sonucm -> fetch(PDO::FETCH_ASSOC)){
			echo '<div><b>Öğrenci Adı Soyadı : </b>'. $bilgilerimceka['yazarAdi'] ."  " .$bilgilerimceka['yazarSoyad'] .'  -  '.$bilgilerimceka['yazarNo']. '  -  '.$bilgilerimceka['yazarOgrTuru'] .'</div><hr>';
